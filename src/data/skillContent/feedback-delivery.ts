export const feedbackDeliveryContent = {
  ...
  definition: {
    ...
    trustFoundation: 'Feedback only works when there\'s psychological safety. Without trust, even well-meaning feedback may feel threatening. Trust is built by consistently showing respect, transparency, and integrity. It helps the recipient stay open, listen generously, and assume good intent.<br/>🔹 If there\'s no trust, feedback won\'t land—no matter how well it\'s worded.<br/>📚 Want to go deeper? Explore the related skill: Building Trust in Professional Relationships.',
    riskOfPoorFeedback: [
