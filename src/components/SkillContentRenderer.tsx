  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
        ...
        <p className="text-lg text-gray-700">{content.definition?.description || 'Skill description not available'}</p>
      </div>
          ...
          {expandedSections.has('pitfalls') && (
            <div className="p-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {content.commonPitfalls.goodFeedback && Array.isArray(content.commonPitfalls.goodFeedback) && (
                  <div>
                ...
                {content.commonPitfalls.badFeedback && Array.isArray(content.commonPitfalls.badFeedback) && (
                  <div>
              ...
              {content.commonPitfalls.alwaysAsk && (
